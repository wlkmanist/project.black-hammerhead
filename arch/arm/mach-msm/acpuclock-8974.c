...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	{ 1, {   96000, HFPLL, 2,  10 },  L2(0),  800000,  17 },
	...
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(22), 1195000, 831 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(22), 1195000, 854 },
	{ 1, { 2880000, HFPLL, 1, 150 }, L2(22), 1210000, 876 },
	{ 1, { 2918400, HFPLL, 1, 152 }, L2(22), 1220000, 891 },
	{ 1, { 2956800, HFPLL, 1, 154 }, L2(22), 1270000, 907 },
	{ 1, { 2995200, HFPLL, 1, 156 }, L2(22), 1280000, 923 },
	{ 1, { 3033600, HFPLL, 1, 158 }, L2(22), 1295000, 961 },
	{ 1, { 3072000, HFPLL, 1, 160 }, L2(22), 1310000, 977 },
	{ 1, { 3110400, HFPLL, 1, 162 }, L2(22), 1325000, 993 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	{ 1, {   96000, HFPLL, 2,  10 },  L2(0),  775000,  17 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	...
	{ 1, { 2918400, HFPLL, 1, 152 }, L2(22), 1155000, 891 },
	{ 1, { 2956800, HFPLL, 1, 154 }, L2(22), 1160000, 907 },
	{ 1, { 2995200, HFPLL, 1, 156 }, L2(22), 1170000, 923 },
	{ 1, { 3033600, HFPLL, 1, 158 }, L2(22), 1175000, 961 },
	{ 1, { 3072000, HFPLL, 1, 160 }, L2(22), 1190000, 977 },
	{ 1, { 3110400, HFPLL, 1, 162 }, L2(22), 1205000, 993 },
	{ 1, { 3148800, HFPLL, 1, 164 }, L2(22), 1220000, 1009},
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	{ 1, {   96000, HFPLL, 2,  10 },  L2(0),  750000,  17 },
